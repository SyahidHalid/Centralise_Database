# python Final_Debtor_Listing.py "0","Debtors Listing and Customer Balance Report as at October 2024_Adjusted.xlsx","Debtor Listing","Pending Processing","0","syahidhalid@exim.com.my","2024-03-29"
# python Final_Debtor_Listing.py "0" "Debtors Listing and Customer Balance Report as at October 2024_Adjusted.xlsx" "Debtor Listing" "Pending Processing" "0" "syahidhalid@exim.com.my" "2024-03-29"
# position_as_at
...
try:
    ...
    SET [jobStartDate] = getdate(), [jobStatus]= 'PY001', [PythonFileName]='Debtor_Listing.py',[jobCompleted] = NULL
...
try:
    ...
    df1 =  str(config.FOLDER_CONFIG["FTP_directory"]+documentName) 
    ...
    D3 = "Modification loss Oct24"
    D4 = "Debtors Listing (C) Oct 2024"
    D5 = "Accrued Interest Oct 2024"
    D6 = "Other Debtors Conv Oct 2024"
    D7 = "Other Debtors Islamic Oct 2024"
    D8 = "IIS Oct 2024"
    D9 = "PIS Oct 2024"
    D10 = "Penalty Oct 2024"
    D11 = "Ta'widh (Active) Oct 2024"
    D12 = "Ta'widh (Recovery) Oct 2024"
...
try:
    ...
    appendfinal3.to_excel(config.FOLDER_CONFIG["FTP_directory"]+"Result_Debtor_Listing_"+str(convert_time)[:19]+".xlsx",index=False) #"ECL 1024 - MIS v1.xlsx" #documentName
