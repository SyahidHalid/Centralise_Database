...
# python Final_ECL_to_MIS.py "0","ECL 1024 - MIS v1.xlsx","ECL to MIS","Pending Processing","0","syahidhalid@exim.com.my","2024-03-29"
# python Final_ECL_to_MIS.py "0" "ECL 1024 - MIS v1.xlsx" "ECL to MIS" "Pending Processing" "0" "syahidhalid@exim.com.my" "2024-03-29"
# position_as_at
try:
    import os
    ...
    try:
        ...
        merge1 = merge.iloc[np.where(merge['Account_No']!="nan")].fillna(0).groupby(['Account_No','Borrower_name','Category','param_name','exchange_rate'])[['LAF_ECL_FC',
                                                                'LAF_ECL_MYR',
                                                                'CnC_ECL_FC',
        ...
        merge1.to_excel(config.FOLDER_CONFIG["FTP_directory"]+"Result_ECL_to_MIS_"+str(convert_time)[:19]+".xlsx",index=False) #"ECL 1024 - MIS v1.xlsx" #documentName
